...
import { AlertCircle, CheckCircle2, Palette, RotateCcw, Save, Settings } from "lucide-react";
        ...
        <>
          <section className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              رنگ‌های کل پلتفرم (وب و اندروید). مقدار پیش‌فرض آبی Xilo است؛ پس از ذخیره همه کلاینت‌ها این ست را می‌گیرند.
            </p>
